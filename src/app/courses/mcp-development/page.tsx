      ...
      <Container>
        <div ref={sectionRef} className="reveal">
          ...
          <h2 className="text-[32px] md:text-[42px] font-semibold tracking-[-0.03em] text-[#ededed] leading-[1.15]">
            3 models.
            <br />
            <span className="text-[#878787]">Build, secure, describe.</span>
          </h2>

          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-4">
            {mcpFrameworks.map((fw) => (
              <div
                key={fw.id}
              ...
              >
                ...
                <ul className="mt-4 space-y-2">
                  {fw.items.map((item, i) => (
                    ...
                    >
                      <span
                        className="mt-[7px] h-1.5 w-1.5 rounded-full bg-[#06b6d4] shrink-0"
                        aria-hidden="true"
                      />
                      {item}
                    </li>
      ...
      <Container>
        ...
        >
          ...
          <div className="inline-flex items-center gap-3">
            <span className="h-px w-8 bg-[#06b6d4]" aria-hidden="true" />
          ...
          {/* Logo mark */}
          <div className="h-16 w-16 rounded-[12px] bg-[#06b6d4]/10 border border-[#06b6d4]/20 flex items-center justify-center">
            <Cable
          ...
          >
            ...
            <br />
            <span className="text-[#a0a0a0]">Connect Everything.</span>
          </h1>

          {/* Subtitle */}
          <p className="max-w-[560px] text-[18px] md:text-[20px] text-[#a0a0a0] leading-[1.65] mt-2">
            Design and build Model Context Protocol servers that connect
            AI agents to your enterprise systems — from your first stdio
            server to production-grade remote deployments.
          </p>
...
export default function McpDevelopmentCourse() {
  return (
    <>
      <McpHero />
      <ModuleSection modules={mcpModules} accent="#06b6d4" />
      <McpFrameworksSection />
      <FaqSection items={mcpFaqItems} />
    </>
  );
}
